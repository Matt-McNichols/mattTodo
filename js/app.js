...
(function () {
	...
	// other lists
	var f2fList = new Todo('f2f');
	var blockedList = new Todo('blocked');
	var dueDateList = new Todo('dueDate');

	// make oneOffList the default list loaded on bootup
	var oneOffList = new Todo('oneOff');
	var todo = oneOffList;
	// click oneOffList
